...
[![GoDoc](https://img.shields.io/static/v1?label=godoc&message=reference&color=blue)](https://pkg.go.dev/github.com/martoc/go-github/v31/github)
...
```go
import "github.com/martoc/go-github/v31/github"	// with go modules enabled (GO111MODULE=on or outside GOPATH)
